...
<div class="container-fluid mx-auto px-md-4 mx-auto text-left pb-5">
    <div class="row">
        ...
        <div class="col-12 col-6 order-1 order-lg-2">
            ...
            <span class="w-100 bordertop pt-4">General enquiries</span>
            ...
            <span class="w-100 bordertop pt-4">Address</span>
            <p class="font-18 text-black mb-0">Unit 1, Ground Floor<br>
                55 Dalston Lane</p>
            <span class="w-100 bordertop pt-4">London E8 2NGMeetings are strictly by appointment only</span>
