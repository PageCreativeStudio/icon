			...
			<header id="masthead" class="site-header mx-auto text-center pt-2 pt-lg-3 pb-2 pb-lg-4 px-md-4">
				<div class="container-fluid mx-auto">
					<div class="row py-3 py-lg-0">
						...
						<div
							class="site-branding order-1 order-lg-2 col-6 col-lg-2 pl-lg-1 pr-lg-4 text-left text-lg-center align-self-center">
					...
					<div class="container-fluid px-3">
						<div class="row justify-content-between">
							...
							<div class="col-12 col-md-3 col-lg-3 col-xl-2 promo__col mt-5 text-left px-4 py-5"
								style="max-height:22rem; background: linear-gradient(0deg, rgba(51, 51, 51, 0.70) 0%, rgba(51, 51, 51, 0.70) 100%), url(<?php echo get_field('promo_image', 'options'); ?>) lightgray -104.911px 0px / 254.545% 100% no-repeat;background-size: cover; background-position-x: left;">
