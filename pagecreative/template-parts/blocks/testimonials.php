<section class="pb-lg-5">
    <div class="testimonialsarea max-width mx-auto text-center pb-3 pb-lg-4 text-center">
        ...
        <a class="d-flex justify-content-center flex-wrap pb-4 px-2"
            ...
            target="_blank">
            <p class="mb-0 font-20 align-self-center text-dark pt-1 font-500 uppercase">excellent</p>
            ...
            <p class="mb-0 font-20 align-self-center text-dark pt-1 font-500 pr-2">50</p>
            <p class="mb-0 font-20 align-self-center text-dark pt-1 font-500 pr-2">reviews</p>
