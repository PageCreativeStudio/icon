<section class="pb-lg-4">
    <div class="testimonialsarea max-width mx-auto text-center pb-3 pb-lg-4 text-center">
        ...
        <a class="d-flex justify-content-center flex-wrap"
            ...
            <p class="mb-0 align-self-center text-dark pt-1">50</p>
            <p class="mb-0 align-self-center text-dark pt-1">reviews</p>
