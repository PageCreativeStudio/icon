<section class="pb-lg-4">
    <div class="testimonialsarea max-width mx-auto text-center pb-3 pb-lg-4 text-center">
        ...
        <a class="d-flex justify-content-center flex-wrap pb-4"
            ...
            target="_blank">
            <p class="mb-0 align-self-center text-dark pt-1 uppercase">excellent</p>
            <div class="d-flex gstars px-3">
            ...
            <p class="mb-0 align-self-center text-dark pt-1 px-2">50</p>
            <p class="mb-0 align-self-center text-dark pt-1 px=2">reviews</p>
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                ...
                <g id="XMLID_11_">
                    ...
                    <path id="XMLID_24_" style="fill: #EA4335;"
                    ...
                    <path id="XMLID_21_" style="fill: #4285F4;"
                    ...
                    <path id="XMLID_18_" style="fill: #FBBC05;"
                    ...
                    <path id="XMLID_3_" style="fill: #34A853;" d="M202.1,0.8h8.8v61.3h-8.8V0.8z"></path>
                    <path id="XMLID_14_" style="fill: #EA4335;"
            ...
            <?php if (have_rows('testimonial_repeater', 'options')) { ?>
                <?php while (have_rows('testimonial_repeater', 'options')) {
                    ...
                    <div class="review-item">
                        <p class="text-dark font-22 font-mb-18 px-2 max-55 mx-auto pb-3">
