...
<div class="container-fluid max-100 mx-auto px-2 px-md-4 mx-auto text-left pb-5 pt-3">
    <div class="row" id="customer_login">
        ...
        <h2 class="font-22 mb-2"><?php esc_html_e('Login', 'woocommerce'); ?></h2>

        <form class="woocommerce-form woocommerce-form-login login mt-3 px-4 py-4 px-lg-5 py-lg-5" method="post" novalidate>
        ...
        <div class="col-12 col-lg-6">
            ...
            <h2 class="font-22 mb-2"><?php esc_html_e('Register', 'woocommerce'); ?></h2>

            <form method="post" class="woocommerce-form woocommerce-form-register register mt-3 px-4 py-4 px-lg-5 py-lg-5" <?php do_action('woocommerce_register_form_tag'); ?>>
                ...
                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                    ...
                    <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="first_name"
                        id="first_name" value="<?php echo esc_attr($_POST['first_name'] ?? ''); ?>" required />
                </p>

                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                    <label for="last_name">Last Name <span class="required">*</span></label>
                    <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="last_name"
                        id="last_name" value="<?php echo esc_attr($_POST['last_name'] ?? ''); ?>" required />
                </p>

                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                    <label for="company_name">Company Name <span class="required">*</span></label>
                    <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="company_name"
                        id="company_name" value="<?php echo esc_attr($_POST['company_name'] ?? ''); ?>" required />
                </p>

                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                    <label for="telephone_number">Telephone Number<span class="required">*</span></label>
                    <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="telephone_number"
                        id="telephone_number" value="<?php echo esc_attr($_POST['telephone_number'] ?? ''); ?>" required />
                </p>
