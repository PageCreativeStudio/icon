...
<div class="container-fluid mx-auto max-100 px-3 px-lg-4 mx-auto text-left pt-3 pt-lg-4" aria-label="<?php esc_html_e( 'Account pages', 'woocommerce' ); ?>">
...
<div class="container-fluid mx-auto max-100 px-3 px-lg-4 mx-auto text-left pt-3 pt-lg-5">
    <div class="borderbottom font-18 font-mb-16 mb-lg-3 py-3">
        <div class="d-flex flex-wrap justify-content-between">
    		<div>
    		    <h2 class="text-black font-25 font-mb-20"> Your Custom Quotes <span class="font-13"> (<?php echo count( WC()->cart->get_cart() ); ?> items) </span> </h2>
    		</div>
            ...
            <div class="col-12 col-lg-7 order-2 order-lg-1">
                <form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
                    ...
                    <div class="woocommerce-cart-form__contents">
                      ...
                      <div class="cart-item card br-10 mb-4 mb-lg-5 px-0 py-0 px-lg-5 py-lg-4 border woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
